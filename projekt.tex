...
\abstract[cs]{
  ...
  Bezpečnostní politika je sada oprávnění, na které virtuální stroje Javy (JVM) omezují možnosti v sobě spuštěných aplikací provádět potenciálně nežádoucí operace.
  Právě možnosti používání bezpečnostních politik byly ve WildFly silně omezeny.
  Výsledkem práce jsou rozšiřující moduly WildFly doplňující programové rozhraní WildFly a webovou administrační konzolu WildFly o možnost
  centrálního stanovování bezpečnostních politik a jejich nasazování na jednotlivé servery domény WildFly bez potřeby jejich 
  domény WildFly. Součástí výsledku je také záplata samotného jádra WildFly, řešící problém nemožnosti výměny bezpečnostní politiky za běhu JVM WildFly.
}
\abstract[en]{
