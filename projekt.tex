...
\abstract[cs]{
  Tato práce se zabývá implementací systému pro centralizovanou správu bezpečnostních politik v distribuovaném prostředí RedHat JBoss/WildFly.
  Práce je tvořena třemi částmi. První část popisuje jak je implementován systém bezpečnostních politik v Javě. Druhá část se zabývá způsobem jak
  bezpečnostní politiky Javy používat v prostředí JBoss/WildFly a řešením souvisejících problémů. Třetí část se pak zabývá návrhem a implementací
  rozšíření aplikačního serveru WildFly umožňujícího centrálně spravovat bezpečnostní politiky nasazené na jednotlivých serverech domény
  aplikačních serverů.
}
\abstract[en]{
  This thesis deals with implementation of system for centralised management of security policies in distributed environment RedHat JBoss/WildFly.
  ...
}
