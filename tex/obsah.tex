...
Access controller je...

Access controller je implementován jako objekt třídy {\tt AccessController}. Standardní Security manager na něj deleguje rozhodnutí, zda akci povolit či nikoliv. \cite[5.5]{oaks}

\begin{verbatim}
try {
    // má tento program oprávnění připojit se na lokální port 6000?
    AccessController.checkPermission(
        new SocketPermission("localhost:6000", "connect")
    );
...
Access controller je založen na čtyřen konceptech: \cite[5]{oaks}
