...
* Konfigurační uzly server=*

%=============================================================================
\section{Druhá etapa}
%=============================================================================

V rámci druhé etapy bylo uživatelské rozhraní pozměněno dle grafického návrhu předvedeného v kapitole \ref{navrhGUI}. [slovní popis gui] V souvislosti s touto změnou bylo nutné rozšířit rovněž subsystém Widlfy. Jeho dosavadní implementace neumožňovala výběr bezpečnostní politiky formou výběru v rozbalovací nabídce.
...
Do konfiguračního stromu subsystému tak vedle dosavadních uzlů server=* popsaných v minulé podkapitole přibyly uzly policy=*, jež reprezentovaly právě jednotlivé soubory bezpečnostní politiky, jež bylo možné jako bezpečnostní politiky jednotlivých serverů nastavit. Tyto uzly nebyly ukládány do konfiguračního XML souboru aplikačního serveru, ale byly při startu serveru vytvářeny načtením seznamu souborů nacházejících se v k tomu určeném adresáři aplikačního serveru.

Hlavní nevýhodou tohoto přístupu byla přetrvávající potřeba zajištění přístupu k souborům bezpečnostních politik uložených na doménovém řadiči, nikoli však již na jednotlivých aplikačních serverech domény. (Více o tomto problému bylo zmíněno v kapitole \ref{navrhGUI}.)
