...
Původ třídy je zde stanoven na základě podpisu JAR archivu z kterého byla třída získána (direktiva {\it signedBy}), URL kořene systému balíčků tříd, ze kterého byla třída získána (direktiva {\it codeBase}) nebo obou těchto kritérií najednou. \cite[5.3.1]{oaks}
...
Wildfly, dříve známý jako JBoss AS, je aplikační server standardu Java EE. Poskytuje běhové prostředí Java EE aplikacím.
