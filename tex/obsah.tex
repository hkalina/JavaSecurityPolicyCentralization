...
Třetí etapa představuje mezistav v přechodu z druhé etapy do etapy čtvrté, na rozdíl od ostatních etap od svého počátku nebyla plánována jako etapa poslední.

Význam konfigurační vlastnosti {\it policy} uzlu {\it server=*} byl pozměněn. Absolutní URL adresa byla nahrazena jménem uzlu bezpečnostní politiky, {\it policy=*}, jehož atribut "file" nadále obsahoval samotnou absolutní URL adresu.
...
Toto je řešeno analogicky jako právě v případě akce navázané na změnu atributu uzlu serveru.
