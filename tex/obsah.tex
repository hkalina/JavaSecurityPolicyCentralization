...
Jako příhodné se pro tento účel zdá využití rozšiřitelnosti systému Wildfly a implementace zmíněné funkcionality formou subsystému aplikačního serveru Wildfly.

Subsystém je rozšířením aplikačního serveru a jeho konfigurace i přítomnost je nastavována zvlášť pro každý profil. Profil je souhrnem konfigurace serveru a je nastavovaný pro celé skupiny serverů.
...
Jako vhodné řešení bylo tedy zvoleno nasazení bezpečnostní politiky v návaznosti na nastavení hodnoty konfigurační proměnné. Každý server aplikačního serveru bude mít v konfiguračním stromu svůj uzel a jeho vlastnost bude svojí hodnotou určovat soubor bezpečnostní politiky nasazený na daném serveru. Bude tato konfigurační proměnná nedefinovaná, bude to signálem pro nepoužití security manageru.
