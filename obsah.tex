...
\begin{enumerate}
  ...
  \item Systém by neměl vyžadovat {\bf restart} serverů domény.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Zajistit přenos souborů bezpečnostní politiky samostatnou aplikací nebo rozšířením WildFly.
\end{enumerate}
...
Sdíleným umístěním by mohl být adresář sdílený například prostřednictvím protokolu FTP, NFS nebo HTTP.
...
Chceme-li tedy zajistit výměnu bezpečnostní politiky bez potřeby restartu aplikačního serveru, je možné vytvořit aplikaci,
která bude nasazena na všech serverech domény a bude naslouchat požadavkům na znovunačtení bezpečnostní politiky.
Stejně tak je možné stejnou funkčnost zajistit ve formě rozšíření aplikačního serveru. V tomto případě však k tomu není žádný důvod.

%-----------------------------------------------------------------------------
\subsection{Přenos souborů bezpečnostní politiky samostatnou aplikací} \label{reseniSpolecne}
%-----------------------------------------------------------------------------

V předchozí variantě byla aplikace nasazená na serverech domény využívána jen ke znovunačítání bezpečnostní politiky.
Tato varianta počítá s využitím aplikace na straně serverů také k nastavení a přenosu samotného souboru bezpečnostní politiky.
Soubory bezpečnostní politiky by v takovém případě ani nemusely být uchovávány na straně serverů domény -- stačilo by uložení jejich obsahu do dočasného souboru před provedením znovunačtení bezpečnostní politiky. Následně by bylo možné tento soubor bezpečně smazat.
...
Na změnu hodnoty v konfiguračním stromu WildFly je totiž při její definici možné provést navázání akce. (viz \ref{!!!!!!!!!!!!!!!!!!!!!!!!})
