...
Tento jednoduchý správce bezpečnosti implementuje výše zmíněnou metodu {\tt checkPermi ssion()}.
...
Tato obrazovka umožňovala spravovat uzly subsystému {\tt mail}. Jednoduchou úpravou tak byla vytvořena konfigurační obrazovku pro správu uzlů politiky.
...
To umožňuje nastavovat použití správce bezpečnosti a bezpečnostní politiky nasazené na jednotlivých serverech nebo celých skupinách serverů WildFly domény.
