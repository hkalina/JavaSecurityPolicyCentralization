...
%-----------------------------------------------------------------------------
\subsection{Statická a dynamická oprávnění}
%-----------------------------------------------------------------------------
...
\iffalse
Dohoda o poskytovatelích autorizačních služeb Javy pro kontejnery (JACC -- Java Authorization Service Provider Contract for Containers)
je specifikací definující vztah mezi Java EE aplikačním serverem a poskytovateli autorizační politiky. \cite{jaccDef}\cite{jaccImplementating}
...
Toto JACC řeší zavedením dvou sad oprávnění třídy:
