...
\begin{itemize}
  ...
  \item Mělo by umožňovat provádět toto nastavení {\bf hromadně} -- pro celé skupiny serverů domény najednou.
...
Na změnu této konfigurační vlastnosti server domény daný jménem uzlu reagoval nasazením dané bezpečnostní politiky, jak bylo navrženo v kapitole \ref{reseniProgramem}.
...
Implementované řešení by mělo být schopné nasadit bezpečnostní politiku na 
