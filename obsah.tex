...
Byla tedy definována třída definující rozšíření, {\tt JsmPolicyExtension}.
...
Subsystém {\tt jsmpolicy} byl definován třídou {\tt SubsystemDefinition} a zaregistrován jakou součást rozšíření {\tt JsmPolicyExtension}.
Uzel serveru ({\tt server=*}) byl definován třídou {\tt ServerDefinition} a rovněž zaregistrován v rámci rozšíření {\tt JsmPolicyExtension}.
...
V rámci definice uzlu serveru byla definována a zaregistrována jeho konfigurační vlastnost {\tt policy}.
...
Způsob registrace této konfigurační vlastnosti ukazuje ukázka kódu \ref{registraceAtributu}.
...
Operace vytvoření uzlu serveru byla ošetřena za pomoci třídy {\tt ServerAdd} a operace změny hodnoty konfigurační vlastnosti {\tt policy} třídou {\tt ServerWriteAttribute}.
Tyto třídy ošetřující operace zajišťovaly nastavení bezpečnostní politiky při provádění operací nad konfiguračním stromem.
Samotné nastavení bezpečnostní politiky přitom zajišťovala samostatná třída {\tt PolicyManager}.
