...
Adresáře zdrojových kódu jsou na CD přiloženy ve formě prostých adresářů a zároveň ve formě stejně pojmenovaných archivů {\tt *.tar.gz}. Tyto archivy pro zjednodušení nejsou v~seznamu níže znovu uváděny.

\begin{itemize}
  \item {\tt projekt.pdf} -- Technická zpráva ve formátu PDF
  \item {\tt projekt} -- Zdrojové soubory technické zprávy

  \item {\tt wildfly-8.0.0.Final} -- Živé demo -- instalace WildFly s~nainstalovanými implementovanými rošířeními, použitelná pro předvedení bakalářské práce
